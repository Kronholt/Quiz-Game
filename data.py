#different quiz data can be loaded from opentd.com
question_data = [
    {"category": "Mythology",
     "type": "boolean",
     "difficulty": "easy",
    ...
    {"category": "Mythology", "type": "boolean", "difficulty": "medium",
     ...
     "correct_answer": "True", "incorrect_answers": ["False"]},
    {"category": "Mythology", "type": "boolean", "difficulty": "medium",
     "question": "The Japanese god Izanagi successfully returned his wife "
                 "Izanami from the Underworld.",
     "correct_answer": "False", "incorrect_answers": ["True"]},
    {"category": "Mythology", "type": "boolean", "difficulty": "hard",
     "question": "Rannamaari was a sea demon that haunted the people of the "
                 "Maldives and had to be appeased monthly with the sacrifice of a"
                 " virgin girl.",
     "correct_answer": "True", "incorrect_answers": ["False"]},
    {"category": "Mythology", "type": "boolean", "difficulty": "medium",
    ...
    {"category": "Mythology", "type": "boolean", "difficulty": "easy",
     ...
     "correct_answer": "False", "incorrect_answers": ["True"]},
    {"category": "Mythology", "type": "boolean", "difficulty": "medium",
     "question": "The Roman god Jupiter was first known as "
                 "Zeus to the Greeks.",
     "correct_answer": "True", "incorrect_answers": ["False"]},
    {"category": "Mythology", "type": "boolean", "difficulty": "easy",
